...
abstract class Model
{
    ...
    public const RULE_EMAIL = 'e-mail';
        ...
        foreach($this->rules() as $attribute => $rules){
            ...
            foreach($rules as $rule){
                ...
                if($ruleName === self::RULE_UNIQUE)
                {
                    ...
                    if($record)
                    {
                        $this->addErrorForRule($attribute, self::RULE_UNIQUE,['value' => $this->getLabel($uniqueAttr) . '  ' . $this->{$uniqueAttr}]);
                    }
                }
            }
        }
    ...
    {
        $message = $this->errorMessages()[$rule] ?? '未定義エラーです。';
